...
![VPN server did not respond]({{ site.url }}/assets/img/vpn-did-not-respond.png)
...
![VPN missing shared secret]({{ site.url }}/assets/img/vpn-missing-shared-secret.png)
...
![Keychain Access System]({{ site.url }}/assets/img/keychain-system.png)
...
![Keychain delete not permitted]({{ site.url }}/assets/img/keychain-delete-not-permitted.png)
...
2. If you're using FileVault, unlock the disk first by selecting Disk Utility from the recovery menu, finding your disk (e.g. Macintosh HD) and choosing File → Unlock. Enter your disk unlock password (usually your Mac login).
3. Open a Terminal window using Utilities → Terminal.
4. Enter the command: `chflags norestricted /Volumes/Macintosh\ HD/Library/Keychains/System.keychain`. This will remove the restricted flag from your **System.keychain** file.
