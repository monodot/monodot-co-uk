...
This is the story of what I've learned so far whilst writing my first book, [_Camel Step-by-Step_][camelsbs].

![The blank canvas]({{ site.url }}/assets/white-wall.jpg)
...
![Camel Step-by-Step landing page]({{ site.url }}/assets/camelsbs-landing.png)
...
![The quiche of writing a technical book]({{ site.url }}/assets/quiche.jpg)
...
![You know nothing, Jon Snow]({{ site.url }}/assets/jon-snow.gif)
...
![Trello board]({{ site.url }}/assets/camelsbs-trello.png)
...
![Writing in Microsoft Word]({{ site.url }}/assets/msword-error.png)
...
![Word Count tracker]({{ site.url }}/assets/word-count.png)
...
![Busy busy busy]({{ site.url }}/assets/busy.jpg)
